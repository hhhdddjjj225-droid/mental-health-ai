    ...
    <div class="sidebar">
      ...
      <div class="ai-assistant-info">
        <div class="breathing-circle">
          <el-image :src="iconUrl" style="width: 25px; height: 25px;" alt="AI助手" class="assistant-icon" />
        </div>
        <h3 class="assistant-name">Roger-AI助手</h3>
      ...
      <div class="chat-messages">
        ...
        <div v-for="msg in messages" :key="msg.id" class="message-item"
          ...
          <div class="message-content">
            ...
            <!-- <div v-if="msg.senderType === 2 && isAiTying" class="message-time">
              正在输入中...
            </div>
