  ...
  <div class="articleDetail-container">
    ...
    <div class="content">
      ...
      <div class="diary-card">
        ...
        <div class="content-wrapper" v-html="formatContent(articleDetail.content)">
        </div>
        <div class="tags-content" v-if="articleDetail.tagArray && articleDetail.tagArray.length > 0">
          <h4 class="tags-title">相关标签</h4>
          <div class="tags-list">
            <el-tag v-for="tag in articleDetail.tagArray" type="info" effect="light" :key="tag" class="tag-item">{{ tag
              }}</el-tag>
          </div>
