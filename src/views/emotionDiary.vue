  ...
  <div class="emotionDiary-container">
    <div class="header-section">
      <div class="header-content">
        <el-image :src="iconUrl" style="width:60px; height: 60px;" alt="情感日记" />
        <h1>情感日记</h1>
      </div>
    </div>
    <div class="content">
      ...
      <div class="diary-card">
        ...
        <div class="emotion-grid">
          <div v-for="emotion in emotionOptions" :key="emotion.name" class="emotion-card"
            ...
            <el-image :src="emotion.url" style="width:50px; height: 50px;" alt="情感" />
      ...
      <div class="diary-card">
        ...
        <div class="detail-form">
          <div class="form-group">
            ...
            <el-input v-model="diaryForm.emotionTriggers" placeholder="今天发生了什么事影响了您的情绪？" type="textarea" :rows="3"
              maxLength="1000" show-word-limit></el-input>
          </div>
          <div class="form-group">
            <div class="form-label">今日感想</div>
            <el-input v-model="diaryForm.diaryContent" placeholder="写下你今天的想法，感受或发生了什么有趣的事..." type="textarea" :rows="5"
